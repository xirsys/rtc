...
(function(a){"undefined"===typeof a.xRtc&&(a.xRtc={});var b=a.xRtc;b.Class(b,"DataChannel",function(a,c){var d=b.Class.proxy(this),f=new b.Logger(this.className),e=b.DataChannel.events;a.onopen=d(function(b){b={event:b};f.debug("open",b);this.trigger(e.open,b)});a.onmessage=d(function(b){f.debug("message",b.data);this.trigger(e.receivedMessage,b.data)});a.onclose=d(function(b){b={event:b};f.debug("close",b);this.trigger(e.close,b)});a.onerror=d(function(a){a=new b.CommonError("onerror","DataChannel error.",
a);f.error("error",a);this.trigger(e.error,a)});a.ondatachannel=d(function(b){b={event:b};f.debug("datachannel",b);this.trigger(e.dataChannel,b)});b.Class.extend(this,b.EventDispatcher,{_logger:f,send:function(c){f.info("send",arguments);try{a.send(c)}catch(d){var n=new b.CommonError("onerror",'DataChannel sending error. Channel state is "'+this.getState()+'"',d);f.error("error",n);this.trigger(e.error,n)}this.trigger(e.sentMessage,c)},getRemoteUser:function(){return c},getName:function(){return a.label},
