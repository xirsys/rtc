...
"WebSocket is not connected!"),n.error("send",d))}function f(b,c){try{if(b=JSON.parse(b),n.debug("getWebSocketURL",b),b&&b.e&&""!=b.e){var d=new a.CommonError("getWebSocketURL","Error occured while getting the URL of WebSockets",b.e);n.error("getWebSocketURL",d);this.trigger(l.serverError,{error:d})}else{var e=b.d.value;n.info("getWebSocketURL",e);"function"===typeof c&&c(e)}}catch(g){this.ajax(a.ServerConnector.settings.URL,"POST","",v(f,c))}}function h(a,b){w=new WebSocket(a+"/ws/"+encodeURIComponent(b));
