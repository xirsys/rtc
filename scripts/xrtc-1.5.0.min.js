...
var d=!1,b=!1,h=!1,f;try{f=new a.webrtc.RTCPeerConnection(null,{optional:[{RtpDataChannels:!0}]});d=!0;try{f.createDataChannel("_XRTCTEST",{reliable:!1});var b=!0,e=new a.webrtc.RTCPeerConnection(null,{});try{h=e.createDataChannel("_XRTCRELIABLETEST",{reliable:!0}).reliable}catch(g){}e.close()}catch(v){}}catch(c){}f&&f.close();return{media:d,data:b,sctp:h}}();a.blobSerializer={pack:BinaryPack.pack,unpack:BinaryPack.unpack};xRtc.utils={newGuid:function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
...
this.ajax(c,"POST",x,f(h,b,e))}})});a.AuthManager.extend({events:{serverError:"servererror"},settings:{unsuccessfulRequestRepeatTimeout:5E3,tokenHandler:"https://api.xirsys.com/getToken",iceHandler:"https://api.xirsys.com/getIceServers"}})})(window);(function(d,a){var k=a.webrtc;a.Class(a,"Stream",function(b){function h(){if(k.detectedBrowser===k.supportedBrowsers.firefox&&22>k.detectedBrowserVersion)throw new a.CommonError("setVideoEnabled","Media track muting is not supported if your Firefox browser version less then 22.");}var f=a.Class.proxy(this),e=new a.Logger(this.className),g=a.Stream.events,v=null;a.Class.property(this,"videoEnabled",function(){var a=b.getVideoTracks();return this.videoAvailable&&a[0].enabled},function(a){h();for(var d=
...
a)});a.Class.extend(this,a.EventDispatcher,{_logger:e,getStream:function(){return b},stop:function(){b.stop()},getId:function(){v||(v=b.id?b.id:a.utils.newGuid());return v},getURL:function(){return k.URL.createObjectURL(b)},assignTo:function(a){this.videoAvailable||this.audioAvailable||0<b.currentTime?(k.detectedBrowser===k.supportedBrowsers.firefox?a.mozSrcObject=b:a.src=this.getURL(),a.play()):d.setTimeout(f(this.assignTo,a),100)}})});a.Stream.extend({events:{ended:"ended"}})})(window,xRtc);(function(d){function a(a){this._sender=a}function k(a,b){var c=new d.FileReader;c.onload=function(a){b(a.target.result)};c.readAsArrayBuffer(a)}function b(a,b){this._sender=a;this.chunkSize=b}function h(a){this._sender=a}function f(a,b){this._sender=a;this._attemptsMaxCount=b;this._buffer=[];this._sendImmediately=!0}"undefined"===typeof d.xRtc&&(d.xRtc={});var e=d.xRtc;e.Class(e,"DataChannel",function(g,v){function c(a){var b=this,c=e.blobSerializer.unpack(a);if(1===c.total)b.trigger(u.progress,
{messageId:c.messageId,percent:100}),b.trigger(u.receivedMessage,{data:e.blobSerializer.unpack(c.data)});else{w[c.messageId]||(w[c.messageId]={data:[],count:0,total:c.total});var g=w[c.messageId];g.data[c.index]=c.data;g.count+=1;0!==g.count%q&&g.total!==g.count||b.trigger(u.progress,{messageId:c.messageId,percent:100*g.count/g.total,cancel:function(){throw"Not implemented yet.";}});g.total===g.count&&k(new d.Blob(g.data),function(a){b.trigger(u.receivedMessage,{data:e.blobSerializer.unpack(a)});
delete g[c.messageId]})}}var x=e.Class.proxy(this),r=new e.Logger(this.className),u=e.DataChannel.events,q=10,n=new a(new b(new a(new h(new f(g,100))),16300)),w={};g.onopen=x(function(a){a={event:a};r.debug("open",a);this.trigger(u.open,a)});g.onmessage=x(function(a){var b=this;r.debug("message",a.data);var e=a.data.constructor;e===d.ArrayBuffer?c.call(b,a.data):e===d.Blob&&k(a.data,function(a){c.call(b,a)})});g.onclose=x(function(a){a={event:a};r.debug("close",a);this.trigger(u.close,a)});g.onerror=
x(function(a){a=new e.CommonError("onerror","DataChannel error.",a);r.error("error",a);this.trigger(u.error,a)});g.ondatachannel=x(function(a){a={event:a};r.debug("datachannel",a);this.trigger(u.dataChannel,a)});e.Class.extend(this,e.EventDispatcher,{_logger:r,getId:function(){return v.getId()+this.getName()},getRemoteUser:function(){return v.getRemoteUser()},getConnection:function(){return v},getName:function(){return g.label},getState:function(){return g.readyState.toLowerCase()},send:function(a,
b,c,d){var g=this,f=g.getState();f!==e.DataChannel.states.open&&(f=new e.CommonError("send",'DataChannel should be opened before sending some data. Current channel state is "'+f+'"'),r.error("error",f),g.trigger(u.error,f));r.info("send",a);n.send(a,function(){var c={data:a};"function"===typeof b&&b(c);g.trigger(u.sentMessage,c)},function(a){a=new e.CommonError("send","DataChannel error.",a);r.error("error",a);"function"===typeof c&&c(a);g.trigger(u.error,a)},function(a){0!==a.count%q&&a.count!==
a.total||g.trigger(u.progress,{messageId:a.messageId,percent:100*a.count/a.total,cancel:function(){throw"Not implemented yet.";}})},d&&d.messageId?{messageId:d.messageId}:null)}})});e.DataChannel.extend({events:{open:"open",progress:"progress",sentMessage:"sentMessage",receivedMessage:"receivedMessage",close:"close",error:"error",dataChannel:"datachannel"},states:{connecting:"connecting",open:"open",closing:"closing",closed:"closed"}});a.prototype.send=function(a,b,c,d,f){this._sender.send(e.blobSerializer.pack(a),
...
b;else if(k.isStun(b)){var h=null,r;r=null;if(d)for(var u=0;u<d.length;u++){var q=d[u];0===q.url.indexOf("turn:")&&(r=-1!==q.url.indexOf("@")?q.url.split("@")[1]:q.url.split("turn:")[1])}r&&(h=b,h.candidate=b.candidate.replace(g,r),h.candidate=b.candidate.replace("typ srflx","typ relay"))}return h},filterSDP:function(b){var d=b;e===a.Connection.connectionTypes.server?d=b.replace(/a=candidate:.*((typ host)|(typ srflx)).*\r\n/g,""):e===a.Connection.connectionTypes.direct&&(d=b.replace(/a=candidate:.*typ relay.*\r\n/g,
""));return d}});var k={isLocal:function(a){return/typ host/.test(a.candidate)},isStun:function(a){return/typ srflx/.test(a.candidate)},isTurn:function(a){return/typ relay/.test(a.candidate)}}});a.Class(a,"Connection",function(h,f,e,g,v,c){function x(b){throw new a.CommonError(b,"The method can be called on '"+a.Room.events.connectionCreated+"' event of the xRtc.Room. Use xRtc.Room.events.connectionCreated for access the event name.");}function r(c,f){function g(){if("function"===typeof f)try{f()}catch(a){}}
...
N=null);if(m){m.onicecandidate=null;m.close();m=null;I=[];E=null;O=M=!1;var c={user:e,connection:this};e=null;this.trigger(a.Connection.events.connectionClosed,c)}}function F(){return m&&(m.iceConnectionState||m.iceState)||"notinitialized"}var t=a.Class.proxy(this),p=new a.Logger(this.className),K=f,B=v||new xRtc.AuthManager,A=[],C=[],G=[],Q=[],m=null,N=null,D=null,J=g,H=null,E=null,M=!1,I=[],L=h,O=!1;(function(){var b=a.HandshakeController.events;J.on(b.receiveIce,t(w)).on(b.receiveOffer,t(z)).on(b.receiveAnswer,
...
w.onopen=q(e);w.onclose=q(g);w.onerror=q(v);w.onmessage=q(c)}function e(a){a={event:a};n.debug("open",a);s&&(y=u.call(this,s));this.trigger(l.connectionOpen,a)}function g(a){y&&(d.clearInterval(y),y=null);a={event:a};n.debug("close",a);this.trigger(l.connectionClose,a);w=null}function v(b){b=new a.CommonError("onerror","WebSocket has got an error",b);n.error("error",b);this.trigger(l.connectionError,{error:b})}function c(a){var b={message:a};n.debug("message",b);this.trigger(l.message,b);if(x(a))if(a=
...
d);n.error("parseServerMessage",e,b);this.trigger(l.messageFormatError,{error:e})}return c}function u(a){return d.setInterval(function(){b.call(this,{})},a)}var q=a.Class.proxy(this),n=new a.Logger(this.className),w=null,z=null,s=k?k.pingInterval:5E3,y=null,l=a.ServerConnector.events;a.Class.extend(this,a.EventDispatcher,a.Ajax,{_logger:n,connect:function(b){z=b;b=q(f,b);this.ajax(a.ServerConnector.settings.URL,"POST","",q(h,b))},disconnect:function(){w?(w.close(),z=w=null,n.info("disconnect","Connection with WS has been broken")):
