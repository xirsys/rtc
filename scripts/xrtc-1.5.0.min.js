...
a);N=!0;s.call(this);a=JSON.parse(a.answer);a=new c.RTCSessionDescription(a);h.setRemoteDescription(a);this.trigger(b.Connection.events.answerReceived,{connection:this,user:e,answerData:{answer:a}});this.trigger(b.Connection.events.connectionEstablishing,{connection:this,user:e})}function u(){g.call(this)}function g(){c.detectedBrowser===c.supportedBrowsers.firefox&&O&&(a.clearInterval(O),O=null);if(h){h.onicecandidate=null;h.close();h=null;K=[];E=null;P=N=!1;var d={connection:this,user:e};e=null;
...
function(){g&&(B.off(r.connectionOpen).off(r.connectionClose).off(r.tokenInvalid).off(r.usersUpdated).off(r.userConnected).off(r.userDisconnected).off(r.receiveOffer).off(r.receiveBye).off(r.receiveAnswer).off(r.receiveIce),g=!1);F={};m=null;q.user=null;u=[];A=[];C={}});B.disconnect()},connect:function(a,c){if(!q.user)throw new b.CommonError("connect","Need to enter the room before you connect someone.");var d=w(a);if(null==d)d=b.CommonError("connect","Target user not found."),this.trigger(b.Room.events.error,
...
connectionAccepted:"connectionaccepted",connectionDeclined:"connectiondeclined",usersUpdated:"usersupdated",userConnected:"userconnected",userDisconnected:"userdisconnected",tokenInvalid:"tokeninvalid",error:"error"},settings:{info:{domain:a.document.domain,application:"default",name:"default"},enterOptions:{autoReply:!0}}})})(window);xRtc.userMedia={};
