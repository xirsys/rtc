...
var d=!1,b=!1,h=!1,f;try{f=new a.webrtc.RTCPeerConnection(null,{optional:[{RtpDataChannels:!0}]});d=!0;try{f.createDataChannel("_XRTCTEST",{reliable:!1});var b=!0,e=new a.webrtc.RTCPeerConnection(null,{});try{h=e.createDataChannel("_XRTCRELIABLETEST",{reliable:!0}).reliable}catch(g){}e.close()}catch(u){}}catch(c){}f&&f.close();return{media:d,data:b,sctp:h}}();a.blobSerializer={pack:BinaryPack.pack,unpack:BinaryPack.unpack};xRtc.utils={newGuid:function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
...
a)});a.Class.extend(this,a.EventDispatcher,{_logger:e,getStream:function(){return b},stop:function(){b.stop()},getId:function(){u||(u=b.id?b.id:a.utils.newGuid());return u},getURL:function(){return k.URL.createObjectURL(b)},assignTo:function(a){this.videoAvailable||this.audioAvailable||0<b.currentTime?(k.detectedBrowser===k.supportedBrowsers.firefox?a.mozSrcObject=b:a.src=this.getURL(),a.play()):d.setTimeout(f(this.assignTo,a),100)}})});a.Stream.extend({events:{ended:"ended"}})})(window,xRtc);(function(d){function a(a){this._sender=a}function k(a,b){var c=new d.FileReader;c.onload=function(a){b(a.target.result)};c.readAsArrayBuffer(a)}function b(a,b){this._sender=a;this.chunkSize=b}function h(a){this._sender=a}function f(a,b){this._sender=a;this._attemptsMaxCount=b;this._buffer=[];this._sendImmediately=!0}"undefined"===typeof d.xRtc&&(d.xRtc={});var e=d.xRtc;e.Class(e,"DataChannel",function(g,u){function c(a){var b=this,c=e.blobSerializer.unpack(a);if(1===c.total)b.trigger(v.receivedMessage,
{data:e.blobSerializer.unpack(c.data)});else{w[c.messageId]||(w[c.messageId]={data:[],count:0,total:c.total});var g=w[c.messageId];g.data[c.index]=c.data;g.count+=1;0!==g.count%q&&g.total!==g.count||b.trigger(v.progress,{messageId:c.messageId,percent:100*g.count/g.total,cancel:function(){throw"Not implemented yet.";}});g.total===g.count&&k(new d.Blob(g.data),function(a){b.trigger(v.receivedMessage,{data:e.blobSerializer.unpack(a)});delete g[c.messageId]})}}var x=e.Class.proxy(this),r=new e.Logger(this.className),
v=e.DataChannel.events,q=10,n=new a(new b(new a(new h(new f(g,100))),16300)),w={};g.onopen=x(function(a){a={event:a};r.debug("open",a);this.trigger(v.open,a)});g.onmessage=x(function(a){var b=this;r.debug("message",a.data);var e=a.data.constructor;e===d.ArrayBuffer?c.call(b,a.data):e===d.Blob&&k(a.data,function(a){c.call(b,a)})});g.onclose=x(function(a){a={event:a};r.debug("close",a);this.trigger(v.close,a)});g.onerror=x(function(a){a=new e.CommonError("onerror","DataChannel error.",a);r.error("error",
a);this.trigger(v.error,a)});g.ondatachannel=x(function(a){a={event:a};r.debug("datachannel",a);this.trigger(v.dataChannel,a)});e.Class.extend(this,e.EventDispatcher,{_logger:r,getId:function(){return u.getId()+this.getName()},getRemoteUser:function(){return u.getRemoteUser()},getConnection:function(){return u},getName:function(){return g.label},getState:function(){return g.readyState.toLowerCase()},send:function(a,b,c,d){var g=this,f=g.getState();f!==e.DataChannel.states.open&&(f=new e.CommonError("send",
'DataChannel should be opened before sending some data. Current channel state is "'+f+'"'),r.error("error",f),g.trigger(v.error,f));r.info("send",a);n.send(a,function(){var c={data:a};"function"===typeof b&&b(c);g.trigger(v.sentMessage,c)},function(a){a=new e.CommonError("send","DataChannel error.",a);r.error("error",a);"function"===typeof c&&c(a);g.trigger(v.error,a)},function(a){0!==a.count%q&&a.count!==a.total||g.trigger(v.progress,{messageId:a.messageId,percent:100*a.count/a.total,cancel:function(){throw"Not implemented yet.";
...
w.onopen=q(e);w.onclose=q(g);w.onerror=q(u);w.onmessage=q(c)}function e(a){a={event:a};n.debug("open",a);s&&(y=v.call(this,s));this.trigger(l.connectionOpen,a)}function g(a){y&&(d.clearInterval(y),y=null);a={event:a};n.debug("close",a);this.trigger(l.connectionClose,a);w=null}function u(b){b=new a.CommonError("onerror","WebSocket has got an error",b);n.error("error",b);this.trigger(l.connectionError,{error:b})}function c(a){var b={message:a};n.debug("message",b);this.trigger(l.message,b);if(x(a))if(a=
...
d);n.error("parseServerMessage",e,b);this.trigger(l.messageFormatError,{error:e})}return c}function v(a){return d.setInterval(function(){b.call(this,{})},a)}var q=a.Class.proxy(this),n=new a.Logger(this.className),w=null,z=null,s=k?k.pingInterval:5E3,y=null,l=a.ServerConnector.events;a.Class.extend(this,a.EventDispatcher,a.Ajax,{_logger:n,connect:function(b){z=b;b=q(f,b);this.ajax(a.ServerConnector.settings.URL,"POST","",q(h,b))},disconnect:function(){w?(w.close(),z=w=null,n.info("disconnect","Connection with WS has been broken")):
...
y.sort(c);this.trigger(a.Room.events.userConnected,{user:b.user})})).on(s.userDisconnected,n(function(b){y.splice(q(y,b.user.id),1);y.sort(c);this.trigger(a.Room.events.userDisconnected,{user:b.user})})).on(s.receiveOffer,n(e)).on(s.receiveBye,n(g)).on(s.receiveAnswer,function(c){if(c.senderId&&c.connectionId){var d=x(c.senderId);if(d){var e=C[c.connectionId];e?e.userId===d.id&&(b.trigger(a.Room.events.connectionAccepted,{user:d,connection:r(c.connectionId),data:c.acceptData}),e.hc.trigger(z.receiveAnswer,
