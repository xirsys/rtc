...
N=null);if(!R){R=!0;var c=e;m&&(m.onicecandidate=null,m.close(),m=null,I=[],F=null,O=M=!1,e=null);this.trigger(a.Connection.events.connectionClosed,{user:c,connection:this})}}function t(){return m&&(m.iceConnectionState||m.iceState)||"notinitialized"}var v=a.Class.proxy(this),q=new a.Logger(this.className),K=f,C=p||new xRtc.AuthManager,B=[],D=[],G=[],Q=[],m=null,N=null,E=null,J=k,H=null,F=null,M=!1,I=[],L=g,O=!1,R=!1;(function(){var b=a.HandshakeController.events;J.on(b.receiveIce,v(y)).on(b.receiveOffer,
v(A)).on(b.receiveAnswer,v(u)).on(b.receiveBye,v(z))}).call(this);a.Class.extend(this,a.EventDispatcher,{_logger:q,getId:function(){return L},getRemoteUser:function(){return e},_open:function(d){O=!0;var f=this,t={};a.Class.extend(t,a.Connection.settings.offerOptions);d&&d.offer&&a.Class.extend(t,d.offer);f.trigger(a.Connection.events.connectionOpening,{user:e,connection:f});w.call(f,e,function(){H=new h.IceCandidateFilter(d&&d.connectionType||null,F);m.createOffer(v(function(d){if(!R&&m){b.detectedBrowser===
b.supportedBrowsers.firefox&&(d.sdp=H.filterSDP(d.sdp));q.debug("onCreateOfferSuccess",d);m.setLocalDescription(d);b.detectedBrowser===b.supportedBrowsers.firefox&&21>=b.detectedBrowserVersion&&(d.sdp=-1==d.sdp.indexOf("a=crypto")?d.sdp.replace(/c=IN/g,"a=crypto:1 AES_CM_128_HMAC_SHA1_80 inline:FakeFakeFakeFakeFakeFakeFakeFakeFakeFake\r\nc=IN"):d.sdp);var t={offer:JSON.stringify(d),connectionData:c,connectionType:H.getType(),iceServers:F};q.debug("sendOffer",e.id,d);J.sendOffer(e.id,L,t);f.trigger(a.Connection.events.offerSent,
