...
this.ajax(n,"POST",s,f(d,c,e))}})});b.AuthManager.extend({events:{serverError:"servererror"},settings:{unsuccessfulRequestRepeatTimeout:5E3,tokenHandler:"https://beta.xirsys.com/getToken",iceHandler:"https://beta.xirsys.com/getIceServers"}})})(window);xRtc.dataChannel={};
...
message:"message",messageFormatError:"messageformaterror",serverError:"servererror",tokenInvalid:"tokeninvalid",receiveOffer:"receiveoffer",receiveAnswer:"receiveanswer",receiveIce:"receiveice",receiveBye:"receivebye",usersUpdated:"peers",userConnected:"peer_connected",userDisconnected:"peer_removed"},settings:{URL:"https://beta.xirsys.com/wsList"}})})(window);xRtc.stream={};
...
getRemoteUser:function(){return e},_open:function(a){Q=!0;var d=this,f={};b.Class.extend(f,b.Connection.settings.offerOptions);a&&a.offer&&b.Class.extend(f,a.offer);d.trigger(b.Connection.events.connectionOpening,{connection:d,user:e});w.call(d,e,function(){I=new k.IceCandidateFilter(a&&a.connectionType||null,D);h.createOffer(p(function(a){c.detectedBrowser===c.supportedBrowsers.firefox&&(a.sdp=I.filterSDP(a.sdp));m.debug("onCreateOfferSuccess",a);h.setLocalDescription(a);c.detectedBrowser===c.supportedBrowsers.firefox&&
21>=c.detectedBrowserVersion&&(a.sdp=-1==a.sdp.indexOf("a=crypto")?a.sdp.replace(/c=IN/g,"a=crypto:1 AES_CM_128_HMAC_SHA1_80 inline:FakeFakeFakeFakeFakeFakeFakeFakeFakeFake\r\nc=IN"):a.sdp);var f={offer:JSON.stringify(a),connectionData:n,connectionType:I.getType(),iceServers:D};m.debug("sendOffer",e.id,a);K.sendOffer(e.id,N,f);d.trigger(b.Connection.events.offerSent,{connection:this,user:e,offerData:f})}),p(function(a){a=new b.CommonError("startSession","Cannot create WebRTC offer",a);m.error("onCreateOfferError",
a);d.trigger(b.Connection.events.createOfferError,{connection:d,error:a})}),f)})},close:function(b){K&&e&&K.sendBye(e.id,N,b);g.call(this)},addStream:function(a){Q&&s("addStream");z.push(a);a={connection:this,stream:a,user:{id:H.name,name:H.name}};m.debug("addLocalStream",a);this.trigger(b.Connection.events.localStreamAdded,a)},createDataChannel:function(b){Q&&s("createDataChannel");M.push(b)},getData:function(){return n},getState:function(){var b=0<z.length;return{notinitialized:b?"ready":"not-ready",
"new":b?"ready":"not-ready",opening:"connecting",active:"connected",closing:"disconnecting",closed:b?"ready":"not-ready",stable:"connected","have-local-offer":"ready","have-remote-offer":"connecting"}[h&&(h.signalingState||h.readyState)||"notinitialized"]},getLocalStreams:function(){return z.map(function(b){return b})},getRemoteStreams:function(){return B.map(function(b){return b})},getDataChannels:function(){return G.map(function(b){return b})}})});b.Connection.extend({events:{connectionOpening:"connectionopening",
...
iceSent:"icesent",iceAdded:"iceadded"},connectionTypes:{"default":"default",direct:"direct",server:"server"},settings:{offerOptions:{optional:[],mandatory:{OfferToReceiveAudio:!0,OfferToReceiveVideo:!0}},answerOptions:{optional:[],mandatory:{OfferToReceiveAudio:!0,OfferToReceiveVideo:!0}},peerConnectionOptions:{optional:[{RtpDataChannels:!0},{DtlsSrtpKeyAgreement:!0}]}}});c.RTCPeerConnection.prototype&&!c.RTCPeerConnection.prototype.getLocalStreams&&b.Class.extend(c.RTCPeerConnection.prototype,{getLocalStreams:function(){return this.localStreams},
getRemoteStreams:function(){return this.remoteStreams}});c.MediaStream.prototype.getVideoTracks||(c.detectedBrowser===c.supportedBrowsers.firefox?b.Class.extend(c.MediaStream.prototype,{getVideoTracks:function(){return[]},getAudioTracks:function(){return[]}}):b.Class.extend(c.MediaStream.prototype,{getVideoTracks:function(){return this.videoTracks},getAudioTracks:function(){return this.audioTracks}}))})(window);xRtc.room={};
